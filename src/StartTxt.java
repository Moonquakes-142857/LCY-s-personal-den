...
//            flag = list.get(i).indexOf(",");
//            start = Integer.parseInt(list.get(i).substring(0,flag));
//            end = Integer.parseInt(list.get(i).substring(flag + 1));
//            set.add(start);
//            set.add(end);
//        }
//        nodes = addNode(set);
...
//        setMap(nodes,hp);
//        addLine(hp,line,list);
//        int[] original = nodes;
//        nodes = deleteZeroNode(nodes,line);
//        Set<String> judgeset = new HashSet<>();
//        List<String> reslut = new ArrayList<>();
//        findCircle(line,nodes,reslut,hp,original,judgeset);
//        writeFile(reslut);
//
...
//    }
//    //添加节点
//    private static int[] addNode(Set<Integer> set){
...
//    }
//    //hashmap
//    private static void setMap(int[] nodes,Map<Integer,Integer> hp){
//        for (int i = 0; i < nodes.length; i++) {
//            hp.put(nodes[i],i);
//        }
//    }
//    //添加线并初始化邻接数组
//    private static void addLine(Map<Integer,Integer> hp,int[][] line,List<String> list) {
//        int flag,start,end;
//        for (int i = 0; i < list.size(); i++) {
//            flag = list.get(i).indexOf(",");
//            start = Integer.parseInt(list.get(i).substring(0,flag));
...
//    }
//    //拓扑排序删去一入度为零的点
//    private static int[] deleteZeroNode(int[] nodes,int[][] line){
//        boolean flag;
//        int lengthn = 0;
//        for (int i = 0; i < nodes.length; i++) {
//            flag = false;
...
//    }
//    //寻找闭环
//    public static void  findCircle(int[][] line,int[] nodes,List<String> reslut,Map<Integer,Integer> hp,int[] original,Set<String> judgeset) {
//        // 从出发节点到当前节点的轨迹
...
//        if (line.length > 0) {
//            for(int i=0;i<nodes.length;i++){
//                int returnnum = hp.get(nodes[i]);
//                findCycle(hp.get(nodes[i]), trace, reslut, nodes, line,returnnum,original,judgeset,alllist);
//            }
//        }
//        List<String> answer = new ArrayList<>();
//        for (int i = 0; i < alllist.size(); i++) {
////            middlestr = alllist.get(i);
//            firstSameSettle(alllist.get(i),answer);
//            for (int j = 0; j < answer.size(); j++) {
//                reslut.add(answer.get(j));
//            }
//            answer.removeAll(answer);
//        }
//    }
//    //dfs
//    private static void findCycle(int v,List<Integer> trace,List<String> reslut,int[] nodes,int[][] line,int returnnum,int[] original,Set<String> judgeset,List<List<String>> alllist)
//    {
//        //添加闭环信息
...
//                    return;
//                }
//                sb.append(original[trace.get(j)]+",");
//                j++;
//            }
//            String str = sb.toString();
//            str = sortString(str);
//            if (judgeset.contains(str) == false && (j>2 && j<8)){
...
//            if(line[v][i]==1) {
//                findCycle(i,trace,reslut,nodes,line,returnnum,original,judgeset,alllist);
//            }
//        }
//        trace.remove(trace.size()-1);
//    }
//    //一行排序
//    private static String sortString(String strc){
...
//    }
//    //首位相等的结果排序
//    private static List<String> firstSameSettle(List<String> reslut,List<String> answer){
//        //取数据
...
//    }
//    //初步排序后首项相等的ID进行后续比较
//    private static boolean judgewhichisbig(String A,String B){
