...
//    }
//    //寻找闭环
//    private static void  findCircle(int[][] line,int[] nodes,List<String> reslut,Map<Integer,Integer> hp,int[] original,Set<String> judgeset) {
//        // 从出发节点到当前节点的轨迹
...
//    }
//    //dfs
//    private static void findCycle(int v,List<Integer> trace,int[][] line,int returnnum,int[] original,Set<String> judgeset,List<List<String>> alllist)
//    {
//        //添加闭环信息
...
//    }
//    //首位相等的结果排序
//    private static void firstSameSettle(List<String> reslut,List<String> answer){
//        //取数据
